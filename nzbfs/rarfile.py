...
class RarFile(object):
    ...
    def __init__(self, rarfile, mode="r", charset=None, info_callback=None, opener=open, crc_check = True):
    ...
    def _process_entry(self, item):
        ...
        if self._info_callback:
            self._stop_parsing = self._info_callback(item)
    ...
    def _parse_real(self):
        fd = self._opener(self.rarfile, "rb")
        self._fd = fd
    ...
    def _open_hack(self, inf, psw = None):
        ...
        rf = self.open(inf.volume_file, "rb", 0)
...
class DirectReader(RarExtFile):
    ...
    def _open(self):
        ...
        self.fd = self.rf.open(self.volfile, "rb", 0)
    ...
    def _open_next(self):
        ...
        fd = self.rf.open(self.volfile, "rb", 0)
        self.fd = fd
